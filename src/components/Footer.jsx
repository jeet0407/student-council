        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <h3 className="text-lg font-bold text-white">SVNIT SAMPARK</h3>
            </div>
            <p className="text-sm leading-relaxed">
              Connecting students, faculty, and administration for a better campus experience at SVNIT Surat.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="#announcements" className="hover:text-white hover:underline transition-colors">
                  Announcements
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="https://svnit.ac.in" target="_blank" rel="noopener noreferrer" className="hover:text-white hover:underline transition-colors">
                  SVNIT Official Website
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 pt-6 md:pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-sm text-center sm:text-left">
              &copy; {new Date().getFullYear()} SVNIT SAMPARK. All rights reserved.
            </p>
