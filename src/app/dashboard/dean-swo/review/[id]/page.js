...
export default function DeanSWOReviewPage({ params }) {
  ...
  const handleAccept = async () => {
    ...
    try {
      ...
      alert('Document approved successfully! It has been sent to Dean SW.');
    ...
    <DashboardLayout>
      <div className="container mx-auto px-3 sm:px-4 md:px-6 py-4 md:py-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 mb-4 md:mb-6">
          <h1 className="text-xl sm:text-2xl text-black font-bold">Review Document</h1>
          <button
            onClick={() => router.push('/dashboard/dean-swo')}
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6 mb-4 md:mb-6 text-black">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-sm">
            ...
            <div>
              ...
              <span className="px-2 py-1 bg-yellow-100 text-yellow-800 rounded text-xs sm:text-sm">
