...
export default function DeanSWReviewPage({ params }) {
  ...
  const handleAccept = async () => {
    if (!confirm('Are you sure you want to give final approval to this document? This will mark it as PASSED.')) {
      return;
    }
    ...
    try {
      ...
      alert('Document approved successfully! This is the final approval - document status is now PASSED.');
